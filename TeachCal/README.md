...
├── calculus.exe             # Compiled executable (Windows)
└── README.md                # This file
```
...
### Windows
```bash
gcc -Wall -Wextra -std=c11 src/main.c src/data_structs.c src/utils.c src/data_load.c src/logging.c src/quiz_engine.c -o calculus.exe
```

### Linux/Mac
```bash
gcc -Wall -Wextra -std=c11 src/main.c src/data_structs.c src/utils.c src/data_load.c src/logging.c src/quiz_engine.c -o calculus
```
...
1. Run the executable: `calculus.exe` (Windows) or `./calculus` (Linux/Mac)
